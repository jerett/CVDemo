...
public:
    dng_xy_coord() : x(0.0), y(0.0) {}

    dng_xy_coord(real64 xx, real64 yy) : x(xx), y(yy) {}
    ...
    bool operator==(const dng_xy_coord &coord) const { return coord.x == x && coord.y == y; }

    bool operator!=(const dng_xy_coord &coord) const { return !(*this == coord); }
};

/*****************************************************************************/

inline dng_xy_coord operator+(const dng_xy_coord &A, const dng_xy_coord &B) {
    dng_xy_coord C;
...
inline dng_xy_coord operator*(real64 scale, const dng_xy_coord &A) {
    dng_xy_coord B;
...
inline real64 operator*(const dng_xy_coord &A, const dng_xy_coord &B) {
