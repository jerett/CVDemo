...
// returns false and leaves *result unchanged.
bool SafeUint32Add(uint32 arg1, uint32 arg2, uint32 *result);
...
// wraparound), stores this result in *result and returns true. Otherwise,
// returns false and leaves *result unchanged.
bool SafeUint32Mult(uint32 arg1, uint32 arg2, uint32 *result);
bool SafeUint32Mult(uint32 arg1, uint32 arg2, uint32 arg3, uint32 *result);
bool SafeUint32Mult(uint32 arg1, uint32 arg2, uint32 arg3, uint32 arg4, uint32 *result);
...
uint32 SafeUint32Mult(uint32 arg1, uint32 arg2, uint32 arg3);
uint32 SafeUint32Mult(uint32 arg1, uint32 arg2, uint32 arg3, uint32 arg4);
...
bool RoundUpUint32ToMultiple(uint32 val, uint32 multiple_of, uint32 *result);
...
// sub-optimal run-time implementation pre-C++11
 if (!(std::numeric_limits<TSrc>::is_integer &&
    ...
    static_assert(std::numeric_limits<TSrc>::is_integer && !std::numeric_limits<TSrc>::is_signed && std::numeric_limits<TDest>::is_integer
                      && !std::numeric_limits<TDest>::is_signed,
...
#define CHECK_SAFE_UINT32                                                                                       \
    static_assert(std::numeric_limits<T>::is_integer && !std::numeric_limits<T>::is_signed && (sizeof(T) == 4), \
...
public:
    ...
    inline uint32 Get() const { return fValue; }
    ...
    const dng_safe_uint32 operator+(const dng_safe_uint32 &x) const { return dng_safe_uint32(*this) += x; }
...
public:
    ...
    inline int32 Get() const { return fValue; }
