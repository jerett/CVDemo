...
public:
    ...
    uint32 Size() const { return TagTypeSize(Type()) * Count(); }
...
public:
    ...
    void SetData(const void *data) { fData = data; }
...
public:
    ...
    void Set(uint8 value) { fValue = value; }
};
...
public:
    ...
    void Set(uint16 value) { fValue = value; }
};
...
public:
    ...
    void Set(real64 value) { fValue = value; }
};
...
private:
    dng_srational fEntry[kMaxColorPlanes * kMaxColorPlanes];
...
public:
    ...
    void SetChained(uint32 offset) { fChained = offset; }
...
public:
    ...
    void SetTileOffset(uint32 index, uint32 offset) { fTileOffsetData[index] = offset; }

    void SetTileByteCount(uint32 index, uint32 count) { fTileByteCountData[index] = count; }

    bool WritingStrips() const { return fStrips; }
};
...
public:
    ...
    uint32 Size() const { return fExifIFD.Size() + fGPSIFD.Size(); }
...
class dng_write_tiles_task : public dng_area_task, private dng_uncopyable {
protected:
