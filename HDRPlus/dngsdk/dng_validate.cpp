    ...
    try {
        ...
        if (gDumpStage1.NotEmpty()) {
            if (negative->Stage1Image()) {
                ...
                writer.WriteTIFF(host, stream2, stage1, stage1.Planes() >= 3 ? piRGB : piBlackIsZero);
            }
        ...
        if (gDumpStage2.NotEmpty()) {
            ...
            if (negative->Stage2Image()) {
                ...
                writer.WriteTIFF(host, stream2, stage2, stage2.Planes() >= 3 ? piRGB : piBlackIsZero);
            }
        ...
        if (negative->Stage2Image()) {
            ...
            negative->BuildStage3Image(host, gMosaicPlane);
        }
        ...
        if (gProxyDNGSize) {
            ...
            negative->ConvertToProxy(host, writer, gProxyDNGSize);
        }
        ...
        if (gDumpStage3.NotEmpty()) {
            ...
            writer.WriteTIFF(host, stream2, stage3, stage3.Planes() >= 3 ? piRGB : piBlackIsZero);
        ...
        if (gDumpTransparency.NotEmpty()) {
            if (negative->TransparencyMask()) {
                ...
                writer.WriteTIFF(host, stream2, transparencyMask, piBlackIsZero);
            }
        ...
        if (gDumpDepthMap.NotEmpty()) {
            if (negative->HasDepthMap()) {
                ...
                writer.WriteTIFF(host, stream2, depthMap, piBlackIsZero);
            }
        ...
        if (gDumpDNG.NotEmpty()) {
            ...
            for (uint32 previewIndex = 0; previewIndex < 2; previewIndex++) {
                ...
                dng_timer timer(previewIndex == 0 ? "Build thumbnail time" : "Build preview time");
                ...
                preview->fInfo.fColorSpace = previewImage->Planes() == 1 ? previewColorSpace_GrayGamma22 : previewColorSpace_sRGB;
...

            {
                ...
                writer.WriteDNG(host, stream2, *negative.Get(), &previewList, dngVersion_Current, false);
            }
        ...
        if (gDumpTIF.NotEmpty()) {
...

            {
                ...
                writer.WriteTIFF(host,
                                 stream2,
                                 *finalImage.Get(),
                                 finalImage->Planes() >= 3 ? piRGB : piBlackIsZero,
                                 ccUncompressed,
                                 negative.Get(),
                                 &render.FinalSpace());
            }
