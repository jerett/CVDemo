...
dng_tile_iterator::dng_tile_iterator(const dng_image &image, const dng_rect &area)
...
{
    Initialize(image.RepeatingTile(), area & image.Bounds());
}

/*****************************************************************************/

dng_tile_iterator::dng_tile_iterator(const dng_point &tileSize, const dng_rect &area)
...

{
    ...
    Initialize(tile, area);
}

/*****************************************************************************/

dng_tile_iterator::dng_tile_iterator(const dng_rect &tile, const dng_rect &area)
...
void dng_tile_iterator::Initialize(const dng_rect &tile, const dng_rect &area) {
    fArea = area;
...
dng_tile_reverse_iterator::dng_tile_reverse_iterator(const dng_image &image, const dng_rect &area)
...
dng_tile_reverse_iterator::dng_tile_reverse_iterator(const dng_point &tileSize, const dng_rect &area)
...
dng_tile_reverse_iterator::dng_tile_reverse_iterator(const dng_rect &tile, const dng_rect &area)
