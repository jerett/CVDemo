...
bool dng_ifd::ParseTag(dng_stream &stream, uint32 parentCode, uint32 tagCode, uint32 tagType, uint32 tagCount, uint64 tagOffset) {
    uint32 j;
    uint32 k;
    uint32 n;
    ...
    switch (tagCode) {
        ...
        case tcCompression: {
            ...
            if (fCompression == 0) {
...

                {
                    ...
                    sprintf(message, "%s has invalid zero compression code", LookupParentCode(parentCode));
        ...
        case tcStripOffsets: {
            ...
            if (gVerbose) {
                ...
                DumpTagValues(stream, "Offset", parentCode, tagCode, tagType, tagCount);
            }
        ...
        case tcStripByteCounts: {
            ...
            if (gVerbose) {
                ...
                DumpTagValues(stream, "Count", parentCode, tagCode, tagType, tagCount);
            }
        ...
        case tcSubIFDs: {
            ...
            if (gVerbose) {
                DumpTagValues(stream, "IFD", parentCode, tagCode, ttLong, tagCount);
            }
        ...
        case tcJPEGTables: {
            ...
            if (gVerbose) {
                printf("JPEGTables: count = %u, offset = %u\n", (unsigned)fJPEGTablesCount, (unsigned)fJPEGTablesOffset);
            }
        ...
        case tcYCbCrCoefficients: {
            ...
            if (gVerbose) {
                printf("YCbCrCoefficients: R = %0.3f, G = %0.3f, B = %0.3f\n", fYCbCrCoefficientR, fYCbCrCoefficientG, fYCbCrCoefficientB);
            }
        ...
        case tcYCbCrSubSampling: {
            ...
            if (gVerbose) {
                printf("YCbCrSubSampling: H = %u, V = %u\n", (unsigned)fYCbCrSubSampleH, (unsigned)fYCbCrSubSampleV);
            }
        ...
        case tcCFARepeatPatternDim: {
            ...
            if (gVerbose) {
                printf("CFARepeatPatternDim: Rows = %u, Cols = %u\n", (unsigned)fCFARepeatPatternRows, (unsigned)fCFARepeatPatternCols);
            }
        ...
        case tcCFAPattern: {
            ...
            if (!CheckTagCount(parentCode, tagCode, tagCount, fCFARepeatPatternRows * fCFARepeatPatternCols)) {
                return false;
            }

            if (fCFARepeatPatternRows < 1 || fCFARepeatPatternRows > kMaxCFAPattern || fCFARepeatPatternCols < 1
                || fCFARepeatPatternCols > kMaxCFAPattern) {
                return false;
            }
        ...
        case tcLinearizationTable: {
            ...
            if (gVerbose) {
                DumpTagValues(stream, "Table", parentCode, tagCode, tagType, tagCount);
            }
        ...
        case tcBlackLevelRepeatDim: {
            ...
            if (gVerbose) {
                printf("BlackLevelRepeatDim: Rows = %u, Cols = %u\n", (unsigned)fBlackLevelRepeatRows, (unsigned)fBlackLevelRepeatCols);
            }
        ...
        case tcBlackLevel: {
            ...
            if (!CheckTagCount(parentCode, tagCode, tagCount, fBlackLevelRepeatRows * fBlackLevelRepeatCols * fSamplesPerPixel)) {
                return false;
            }

            if (fBlackLevelRepeatRows < 1 || fBlackLevelRepeatRows > kMaxBlackPattern || fBlackLevelRepeatCols < 1
                || fBlackLevelRepeatCols > kMaxBlackPattern || fSamplesPerPixel < 1 || fSamplesPerPixel > kMaxSamplesPerPixel) {
                return false;
            }
            ...
            if (gVerbose) {
                ...
                if (fBlackLevelRepeatRows == 1 && fBlackLevelRepeatCols == 1) {
                    for (n = 0; n < fSamplesPerPixel; n++) {
        ...
        case tcBlackLevelDeltaH: {
            ...
            if (gVerbose) {
                DumpTagValues(stream, "Delta", parentCode, tagCode, tagType, tagCount);
            }
        ...
        case tcDefaultScale: {
            ...
            if (gVerbose) {
                printf("DefaultScale: H = %0.4f V = %0.4f\n", fDefaultScaleH.As_real64(), fDefaultScaleV.As_real64());
            }
        ...
        case tcDefaultCropOrigin: {
            ...
            if (gVerbose) {
                printf("DefaultCropOrigin: H = %0.2f V = %0.2f\n", fDefaultCropOriginH.As_real64(), fDefaultCropOriginV.As_real64());
            }
        ...
        case tcDefaultCropSize: {
            ...
            if (gVerbose) {
                printf("DefaultCropSize: H = %0.2f V = %0.2f\n", fDefaultCropSizeH.As_real64(), fDefaultCropSizeV.As_real64());
            }
        ...
        case tcPreviewApplicationName: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fPreviewInfo.fApplicationName, false);
        ...
        case tcPreviewApplicationVersion: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fPreviewInfo.fApplicationVersion, false);
        ...
        case tcPreviewSettingsName: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fPreviewInfo.fSettingsName, false);
        ...
        case tcPreviewColorSpace: {
            ...
            fPreviewInfo.fColorSpace = (PreviewColorSpaceEnum)stream.TagValue_uint32(tagType);
        ...
        case tcPreviewDateTime: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fPreviewInfo.fDateTime, false);
        ...
        case tcSubTileBlockSize: {
            ...
            if (gVerbose) {
                printf("SubTileBlockSize: rows = %u, cols = %u\n", (unsigned)fSubTileBlockRows, (unsigned)fSubTileBlockCols);
            }
        ...
        case tcOpcodeList1: {
            ...
            if (gVerbose) {
                printf("OpcodeList1: count = %u, offset = %u\n", (unsigned)fOpcodeList1Count, (unsigned)fOpcodeList1Offset);
            }
        ...
        case tcOpcodeList2: {
            ...
            if (gVerbose) {
                printf("OpcodeList2: count = %u, offset = %u\n", (unsigned)fOpcodeList2Count, (unsigned)fOpcodeList2Offset);
            }
        ...
        case tcOpcodeList3: {
            ...
            if (gVerbose) {
                printf("OpcodeList3: count = %u, offset = %u\n", (unsigned)fOpcodeList3Count, (unsigned)fOpcodeList3Offset);
            }
        ...
        case tcEnhanceParams: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fEnhanceParams, false);
        ...
        case tcNoiseReductionApplied: {
            ...
            if (gVerbose) {
                printf("NoiseReductionApplied: %u/%u\n", (unsigned)fNoiseReductionApplied.n, (unsigned)fNoiseReductionApplied.d);
            }
...
void dng_ifd::PostParse() {
    ...
    uint32 defaultWhite = (fSampleFormat[0] == sfFloatingPoint) ? 1 : (uint32)((((uint64)1) << fBitsPerSample[0]) - 1);
    ...
    if (fAntiAliasStrength.As_real64() < 0.0 || fAntiAliasStrength.As_real64() > 1.0) {
#if qDNGValidate
...
bool dng_ifd::IsValidCFA(dng_shared &shared, uint32 parentCode) {
    uint32 j;
    uint32 k;
    uint32 n;
    ...
    if (fCFARepeatPatternRows < 1 || fCFARepeatPatternRows > kMaxCFAPattern || fCFARepeatPatternCols < 1
        ...
        ReportError("Missing or invalid CFAPatternRepeatDim", LookupParentCode(parentCode));
    ...
    for (j = 0; j < fCFARepeatPatternRows; j++) {
        for (k = 0; k < fCFARepeatPatternCols; k++) {
            ...
            if (!found) {
                ...
                ReportError("CFAPattern contains colors not included in the CFAPlaneColor tag", LookupParentCode(parentCode));
    ...
    for (n = 0; n < shared.fCameraProfile.fColorPlanes; n++) {
        if (count[n] == 0) {
            ...
            ReportError("CFAPattern does not contain all the colors in the CFAPlaneColor tag", LookupParentCode(parentCode));
    ...
    if (fCFALayout < 1 || fCFALayout > 9) {
        ...
        ReportError("Invalid CFALayout", LookupParentCode(parentCode));
...
bool dng_ifd::IsValidDNG(dng_shared &shared, uint32 parentCode) {
    uint32 j;
    ...
    uint32 defaultWhite = isFloatingPoint ? 1 : (uint32)((((uint64)1) << fBitsPerSample[0]) - 1);
    ...
    if (!fUsesNewSubFileType) {
        ...
        ReportError("Missing NewSubFileType", LookupParentCode(parentCode));
    ...
    if (fNewSubFileType != sfMainImage && fNewSubFileType != sfPreviewImage && fNewSubFileType != sfTransparencyMask
        && fNewSubFileType != sfPreviewMask && fNewSubFileType != sfDepthMap && fNewSubFileType != sfPreviewDepthMap
        && fNewSubFileType != sfEnhancedImage && fNewSubFileType != sfAltPreviewImage) {
#if qDNGValidate

        ReportError("Unexpected NewSubFileType", LookupParentCode(parentCode));
    ...
    if (fImageWidth < 1) {
        ...
        ReportError("Missing or invalid ImageWidth", LookupParentCode(parentCode));
    ...
    if (fImageLength < 1) {
        ...
        ReportError("Missing or invalid ImageLength", LookupParentCode(parentCode));
    ...
    if (fImageWidth > kMaxImageSide || fImageLength > kMaxImageSide) {
#if qDNGValidate
    ...
    if (fNewSubFileType == sfTransparencyMask || fNewSubFileType == sfPreviewMask) {
        if (fPhotometricInterpretation != piTransparencyMask) {
#if qDNGValidate

            ReportError("NewSubFileType requires PhotometricInterpretation = TransparencyMask", LookupParentCode(parentCode));
    ...
    else if (fNewSubFileType == sfDepthMap || fNewSubFileType == sfPreviewDepthMap) {
        if (fPhotometricInterpretation != piDepth) {
#if qDNGValidate

            ReportError("NewSubFileType requires PhotometricInterpretation = Depth", LookupParentCode(parentCode));
        ...
        switch (fPhotometricInterpretation) {
            ...
            case piYCbCr: {
                if (isMainIFD) {
                    ...
                    ReportError("PhotometricInterpretation requires NewSubFileType = 1", LookupParentCode(parentCode));
            ...
            case piCFA: {
                if (!isMainIFD) {
                    ...
                    ReportError("PhotometricInterpretation requires NewSubFileType = 0", LookupParentCode(parentCode));
            ...
            default: {
                ...
                ReportError("Missing or invalid PhotometricInterpretation", LookupParentCode(parentCode));
    ...
    switch (fPhotometricInterpretation) {
        case piBlackIsZero: {
            ...
            if (isColor && isMainIFD) {
                ...
                ReportError("PhotometricInterpretation forbids use of ColorMatrix1 tag", LookupParentCode(parentCode));
        ...
        case piCFA: {
            if (isMonochrome) {
                ...
                ReportError("PhotometricInterpretation requires use of ColorMatrix1 tag", LookupParentCode(parentCode));
    ...
    if (isFloatingPoint) {
        if (fPhotometricInterpretation != piCFA && fPhotometricInterpretation != piLinearRaw
    ...
    if (fSamplesPerPixel < minSamplesPerPixel || fSamplesPerPixel > maxSamplesPerPixel) {
#if qDNGValidate

        ReportError("Missing or invalid SamplesPerPixel", LookupParentCode(parentCode));
    ...
    for (j = 0; j < kMaxSamplesPerPixel; j++) {
        if (j < fSamplesPerPixel) {
            if (fBitsPerSample[j] < minBitsPerSample || fBitsPerSample[j] > maxBitsPerSample) {
#if qDNGValidate

                ReportError("Missing or invalid BitsPerSample", LookupParentCode(parentCode));
            ...
            if (isFloatingPoint && fBitsPerSample[j] != 16 && fBitsPerSample[j] != 24 && fBitsPerSample[j] != 32) {
#if qDNGValidate

                ReportError("Invalid BitsPerSample for floating point", LookupParentCode(parentCode));
            ...
            if (minBitsPerSample == 8 && maxBitsPerSample == 16 && fBitsPerSample[j] != 8 && fBitsPerSample[j] != 16) {
#if qDNGValidate

                ReportError("Rendered previews and integer masks require 8 or 16 bits per sample", LookupParentCode(parentCode));
            ...
            if (j > 0 && fBitsPerSample[j] != fBitsPerSample[0]) {
                ...
                ReportError("BitsPerSample not equal for all samples", LookupParentCode(parentCode));
            ...
            if (fBitsPerSample[j] != 0) {
                ...
                ReportError("Too many values specified in BitsPerSample", LookupParentCode(parentCode));
    ...
    switch (fCompression) {
        ...
        case ccJPEG: {
            if (fPhotometricInterpretation == piRGB) {
                ...
                ReportError("JPEG previews should use PhotometricInterpretation = YCbYb", LookupParentCode(parentCode));
            ...
            if (fBitsPerSample[0] > 16) {
                ...
                ReportError("JPEG compression is limited to 16 bits/sample", LookupParentCode(parentCode));
        ...
        case ccLossyJPEG: {
            if (fPhotometricInterpretation != piLinearRaw) {
                ...
                ReportError("Lossy JPEG compression code requires PhotometricInterpretation = LinearRaw", LookupParentCode(parentCode));
            ...
            if (fBitsPerSample[0] != 8) {
                ...
                ReportError("Lossy JPEG compression is limited to 8 bits/sample", LookupParentCode(parentCode));
        ...
        case ccDeflate: {
            if (!isFloatingPoint && fBitsPerSample[0] != 32 && fPhotometricInterpretation != piTransparencyMask
                && fPhotometricInterpretation != piDepth) {
#if qDNGValidate

                ReportError(
                    "ZIP compression is limited to floating point, 32-bit integer,"
        ...
        default: {
            ...
            ReportError("Unsupported Compression", LookupParentCode(parentCode));
    ...
    if (isFloatingPoint && fCompression == ccDeflate
        && (fPredictor == cpFloatingPoint || fPredictor == cpFloatingPointX2 || fPredictor == cpFloatingPointX4)) {
        // These combinations are supported.
    }

    else if (!isFloatingPoint && fCompression == ccDeflate
             && (fPredictor == cpHorizontalDifference || fPredictor == cpHorizontalDifferenceX2
        ...
        ReportError("Unsupported Predictor", LookupParentCode(parentCode));
    ...
    if (fFillOrder != 1) {
        ...
        ReportError("Unsupported FillOrder", LookupParentCode(parentCode));
    ...
    if (fPlanarConfiguration != pcInterleaved) {
        ...
        ReportError("Unsupported PlanarConfiguration", LookupParentCode(parentCode));
    ...
    if (fExtraSamplesCount != 0) {
        ...
        ReportError("Unsupported ExtraSamples", LookupParentCode(parentCode));
    ...
    for (j = 0; j < fSamplesPerPixel; j++) {
        if (fSampleFormat[j] != (isFloatingPoint ? sfFloatingPoint : sfUnsignedInteger)) {
            ...
            ReportError("Unsupported SampleFormat", LookupParentCode(parentCode));
    ...
    if (fOrientation > 9) {
        ...
        ReportError("Unknown Orientation", LookupParentCode(parentCode));
    ...
    if (fOrientation != 0 && parentCode != 0) {
        ReportWarning("Unexpected Orientation tag", LookupParentCode(parentCode));
    }

    if (fOrientation == 0 && parentCode == 0) {
        ReportWarning("Missing Orientation tag", LookupParentCode(parentCode));
    }
    ...
    if (!fUsesStrips && !fUsesTiles) {
        ...
        ReportError("IFD uses neither strips nor tiles", LookupParentCode(parentCode));
    ...
    if (fUsesStrips && fUsesTiles) {
        ...
        ReportError("IFD uses both strips and tiles", LookupParentCode(parentCode));
    ...
    if (fTileOffsetsCount != tileCount) {
        ...
        ReportError("Missing or invalid Strip/TileOffsets", LookupParentCode(parentCode));
    ...
    if (fTileByteCountsCount != tileCount) {
        ...
        ReportError("Missing or invalid Strip/TileByteCounts", LookupParentCode(parentCode));
    ...
    if (((fActiveArea & imageArea) != fActiveArea) || fActiveArea.IsEmpty()) {
        ...
        ReportError("Invalid ActiveArea", LookupParentCode(parentCode));
    ...
    if (fActiveArea != imageArea) {
        if (shared.fDNGBackwardVersion < dngVersion_1_1_0_0) {
            ...
            ReportError("Non-default ActiveArea tag not allowed in this DNG version", LookupParentCode(parentCode));
    ...
    if (fLinearizationTableCount) {
        if (fLinearizationTableType != ttShort) {
            ...
            ReportError("Invalidate LinearizationTable type", LookupParentCode(parentCode));
        ...
        if (fLinearizationTableCount < 2 || fLinearizationTableCount > 65536) {
#if qDNGValidate

            ReportError("Invalidate LinearizationTable count", LookupParentCode(parentCode));
        ...
        if (isFloatingPoint || fBitsPerSample[0] > 16) {
            ...
            ReportError("Linearization table not allowed for this data type", LookupParentCode(parentCode));
    ...
    if (fBlackLevelRepeatRows < 1 || fBlackLevelRepeatRows > kMaxBlackPattern || fBlackLevelRepeatCols < 1
        ...
        ReportError("Invalid BlackLevelRepeatDim", LookupParentCode(parentCode));
    ...
    if (fBlackLevelDeltaHCount != 0 && fBlackLevelDeltaHCount != fActiveArea.W()) {
#if qDNGValidate

        ReportError("Invalid BlackLevelDeltaH count", LookupParentCode(parentCode));
    ...
    if (fBlackLevelDeltaVCount != 0 && fBlackLevelDeltaVCount != fActiveArea.H()) {
#if qDNGValidate

        ReportError("Invalid BlackLevelDeltaV count", LookupParentCode(parentCode));
    ...
    real64 maxWhite = fLinearizationTableCount ? 65535.0 : (real64)defaultWhite;

    for (j = 0; j < fSamplesPerPixel; j++) {
        if (fWhiteLevel[j] < 1.0 || (fWhiteLevel[j] > maxWhite && !isFloatingPoint)) {
#if qDNGValidate

            ReportError("Invalid WhiteLevel", LookupParentCode(parentCode));
        ...
        for (uint32 k = 0; k < kMaxBlackPattern; k++) {
            for (uint32 s = 0; s < kMaxSamplesPerPixel; s++) {
                ...
                if (black >= fWhiteLevel[s]) {
                    ...
                    ReportError("Invalid BlackLevel", LookupParentCode(parentCode));
    ...
    if (fDefaultScaleH.As_real64() <= 0.0 || fDefaultScaleV.As_real64() <= 0.0) {
#if qDNGValidate
    ...
    if (fDefaultCropOriginH.As_real64() < 0.0 || fDefaultCropOriginV.As_real64() < 0.0
        || fDefaultCropOriginH.As_real64() >= (real64)fActiveArea.W() || fDefaultCropOriginV.As_real64() >= (real64)fActiveArea.H()) {
#if qDNGValidate
    ...
    if (fDefaultCropSizeH.As_real64() <= 0.0 || fDefaultCropSizeV.As_real64() <= 0.0
        || fDefaultCropSizeH.As_real64() > (real64)fActiveArea.W() || fDefaultCropSizeV.As_real64() > (real64)fActiveArea.H()) {
#if qDNGValidate
    ...
    if (fDefaultCropOriginH.As_real64() + fDefaultCropSizeH.As_real64() > (real64)fActiveArea.W()
        || fDefaultCropOriginV.As_real64() + fDefaultCropSizeV.As_real64() > (real64)fActiveArea.H()) {
#if qDNGValidate
    ...
    if (fDefaultUserCropT.As_real64() < 0.0 || fDefaultUserCropL.As_real64() < 0.0 || fDefaultUserCropB.As_real64() > 1.0
        || fDefaultUserCropR.As_real64() > 1.0 || fDefaultUserCropT.As_real64() >= fDefaultUserCropB.As_real64()
    ...
    if (!isMainIFD) {
        if (Round_int32(fDefaultCropOriginH.As_real64()) != 0 || Round_int32(fDefaultCropOriginV.As_real64()) != 0) {
#if qDNGValidate
    ...
    if (fPhotometricInterpretation == piCFA) {
        ...
        if (fDefaultCropOriginH.As_real64() < kMinPad) {
            ReportWarning("Too little padding on left edge of CFA image", "possible interpolation artifacts");
        }

        if (fDefaultCropOriginV.As_real64() < kMinPad) {
            ReportWarning("Too little padding on top edge of CFA image", "possible interpolation artifacts");
        }

        if (fDefaultCropOriginH.As_real64() + fDefaultCropSizeH.As_real64() > (real64)fActiveArea.W() - kMinPad) {
            ReportWarning("Too little padding on right edge of CFA image", "possible interpolation artifacts");
        }

        if (fDefaultCropOriginV.As_real64() + fDefaultCropSizeV.As_real64() > (real64)fActiveArea.H() - kMinPad) {
            ReportWarning("Too little padding on bottom edge of CFA image", "possible interpolation artifacts");
        }
    }
    ...
    if (fRowInterleaveFactor != 1) {
        if (fRowInterleaveFactor < 1 || fRowInterleaveFactor > fImageLength) {
#if qDNGValidate

            ReportError("RowInterleaveFactor out of valid range", LookupParentCode(parentCode));
        ...
        if (shared.fDNGBackwardVersion < dngVersion_1_2_0_0) {
            ...
            ReportError("Non-default RowInterleaveFactor tag not allowed in this DNG version", LookupParentCode(parentCode));
    ...
    if (fSubTileBlockRows != 1 || fSubTileBlockCols != 1) {
        if (fSubTileBlockRows < 2 || fSubTileBlockRows > fTileLength || fSubTileBlockCols < 1 || fSubTileBlockCols > fTileWidth) {
#if qDNGValidate

            ReportError("SubTileBlockSize out of valid range", LookupParentCode(parentCode));
        ...
        if ((fTileLength % fSubTileBlockRows) != 0 || (fTileWidth % fSubTileBlockCols) != 0) {
#if qDNGValidate

            ReportError("TileSize not exact multiple of SubTileBlockSize", LookupParentCode(parentCode));
        ...
        if (shared.fDNGBackwardVersion < dngVersion_1_2_0_0) {
            ...
            ReportError("Non-default SubTileBlockSize tag not allowed in this DNG version", LookupParentCode(parentCode));
...
dng_rect dng_ifd::TileArea(uint32 rowIndex, uint32 colIndex) const {
    dng_rect r;
...
uint32 dng_ifd::TileByteCount(const dng_rect &tile) const {
    if (fCompression == ccUncompressed) {
        uint32 bitsPerRow = tile.W() * fBitsPerSample[0];
...
void dng_ifd::FindTileSize(uint32 bytesPerTile, uint32 cellH, uint32 cellV) {
    uint32 bytesPerSample = fSamplesPerPixel * ((fBitsPerSample[0] + 7) >> 3);
    ...
    fTileLength = Pin_uint32(1, samplesPerTile / fTileWidth, fImageLength);
...
void dng_ifd::FindStripSize(uint32 bytesPerStrip, uint32 cellV) {
    uint32 bytesPerSample = fSamplesPerPixel * ((fBitsPerSample[0] + 7) >> 3);
    ...
    fTileLength = Pin_uint32(1, samplesPerStrip / fTileWidth, fImageLength);
...
bool dng_ifd::IsBaselineJPEG() const {
    ...
    switch (fPhotometricInterpretation) {
        ...
        case piYCbCr: {
            return (fSamplesPerPixel == 3) && (fPlanarConfiguration == pcInterleaved);
        }
