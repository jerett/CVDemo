...
bool dng_camera_profile_info::ParseTag(dng_stream &stream,
    ...
    switch (tagCode) {
        ...
        case tcColorMatrix1: {
            ...
            if (!ParseMatrixTag(stream, parentCode, tagCode, tagType, tagCount, fColorPlanes, 3, fColorMatrix1))
                return false;
        ...
        case tcColorMatrix2: {
            ...
            if (!ParseMatrixTag(stream, parentCode, tagCode, tagType, tagCount, fColorPlanes, 3, fColorMatrix2))
                return false;
        ...
        case tcForwardMatrix1: {
            ...
            if (!ParseMatrixTag(stream, parentCode, tagCode, tagType, tagCount, 3, fColorPlanes, fForwardMatrix1))
                return false;
        ...
        case tcForwardMatrix2: {
            ...
            if (!ParseMatrixTag(stream, parentCode, tagCode, tagType, tagCount, 3, fColorPlanes, fForwardMatrix2))
                return false;
        ...
        case tcReductionMatrix1: {
            ...
            if (!ParseMatrixTag(stream, parentCode, tagCode, tagType, tagCount, 3, fColorPlanes, fReductionMatrix1))
                return false;
        ...
        case tcReductionMatrix2: {
            ...
            if (!ParseMatrixTag(stream, parentCode, tagCode, tagType, tagCount, 3, fColorPlanes, fReductionMatrix2))
                return false;
        ...
        case tcProfileCalibrationSignature: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fProfileCalibrationSignature, false);
        ...
        case tcProfileName: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fProfileName, false);
        ...
        case tcProfileCopyright: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fProfileCopyright, false);
        ...
        case tcProfileHueSatMapData1: {
            ...
            bool skipSat0 = (tagCount == (hueCount * (fProfileSats - 1) * (valCount * 3u)).Get());

            if (!skipSat0) {
                dng_safe_uint32 expected = hueCount * valCount * fProfileSats * 3u;

                if (!CheckTagCount(parentCode, tagCode, tagCount, expected.Get())) {
                    return false;
                }
            }
            ...
            if (gVerbose) {
                ...
                DumpHueSatMap(stream, fProfileHues, fProfileSats, fProfileVals, skipSat0);
            }
        ...
        case tcProfileLookTableData: {
            ...
            bool skipSat0 = (tagCount == (hueCount * (fLookTableSats - 1) * valCount * 3u).Get());
            ...
            if (gVerbose) {
                ...
                DumpHueSatMap(stream, fLookTableHues, fLookTableSats, fLookTableVals, skipSat0);
            }
        ...
        case tcProfileToneCurve: {
            ...
            if (gVerbose) {
                DumpTagValues(stream, "Coord", parentCode, tagCode, tagType, tagCount);
            }
        ...
        case tcUniqueCameraModel: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fUniqueCameraModel, false);
...
bool dng_camera_profile_info::ParseExtended(dng_stream &stream) {
    try {
        ...
        for (uint32 tag_index = 0; tag_index < ifdEntries; tag_index++) {
            ...
            if (!ParseTag(stream, 0, tagCode, tagType, tagCount, tagOffset)) {
#if qDNGValidate
                ...
                if (gVerbose) {
                    ...
                    DumpTagValues(stream, LookupTagType(tagType), 0, tagCode, tagType, tagCount);
                }
...
bool dng_shared::ParseTag(dng_stream &stream,
                          ...
                          int64 /* offsetDelta */) {
    if (parentCode == 0) {
        if (Parse_ifd0(stream, exif, parentCode, tagCode, tagType, tagCount, tagOffset)) {
            return true;
        }
    }

    if (parentCode == 0 || parentCode == tcExifIFD) {
        if (Parse_ifd0_exif(stream, exif, parentCode, tagCode, tagType, tagCount, tagOffset)) {
            return true;
        }
    }
...
bool dng_shared::Parse_ifd0(dng_stream &stream,
    ...
    switch (tagCode) {
        case tcXMP: {
            ...
            if (gVerbose) {
                printf("XMP: Count = %u, Offset = %u\n", (unsigned)fXMPCount, (unsigned)fXMPOffset);
        ...
        case tcIPTC_NAA: {
            ...
            if (gVerbose) {
                printf("IPTC/NAA: Count = %u, Offset = %u\n", (unsigned)fIPTC_NAA_Count, (unsigned)fIPTC_NAA_Offset);
        ...
        case tcLocalizedCameraModel: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fLocalizedCameraModel, false);
        ...
        case tcCameraCalibrationSignature: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fCameraCalibrationSignature, false);
        ...
        case tcAnalogBalance: {
            ...
            bool hasselbladHack = (fDNGVersion == 0 && fCameraProfile.fColorPlanes == 0);
            ...
            if (!ParseVectorTag(stream, parentCode, tagCode, tagType, tagCount, fCameraProfile.fColorPlanes, fAnalogBalance))
                return false;
        ...
        case tcAsShotNeutral: {
            ...
            if (!ParseVectorTag(stream, parentCode, tagCode, tagType, tagCount, fCameraProfile.fColorPlanes, fAsShotNeutral))
                return false;
        ...
        case tcAsShotWhiteXY: {
            ...
            if (gVerbose) {
                printf("AsShotWhiteXY: %0.4f %0.4f\n", fAsShotWhiteXY.x, fAsShotWhiteXY.y);
            }
        ...
        case tcDNGPrivateData: {
            ...
            if (gVerbose) {
                printf("DNGPrivateData: Count = %u, Offset = %u\n", (unsigned)fDNGPrivateDataCount, (unsigned)fDNGPrivateDataOffset);
        ...
        case tcOriginalRawFileName: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fOriginalRawFileName, false);
        ...
        case tcAsShotICCProfile: {
            ...
            if (gVerbose) {
                printf("AsShotICCProfile: Count = %u, Offset = %u\n", (unsigned)fAsShotICCProfileCount, (unsigned)fAsShotICCProfileOffset);
        ...
        case tcAsShotPreProfileMatrix: {
            ...
            if (!ParseMatrixTag(stream, parentCode, tagCode, tagType, tagCount, rows, fCameraProfile.fColorPlanes, fAsShotPreProfileMatrix))
                return false;
        ...
        case tcCurrentICCProfile: {
            ...
            if (gVerbose) {
                printf(
                    "CurrentICCProfile: Count = %u, Offset = %u\n", (unsigned)fCurrentICCProfileCount, (unsigned)fCurrentICCProfileOffset);
        ...
        case tcCurrentPreProfileMatrix: {
            ...
            if (!ParseMatrixTag(
                    stream, parentCode, tagCode, tagType, tagCount, rows, fCameraProfile.fColorPlanes, fCurrentPreProfileMatrix))
                return false;
        ...
        case tcAsShotProfileName: {
            ...
            ParseStringTag(stream, parentCode, tagCode, tagCount, fAsShotProfileName, false);
        ...
        case tcOriginalDefaultFinalSize: {
            ...
            if (gVerbose) {
                printf("OriginalDefaultFinalSize: H = %d V = %d\n", (int)fOriginalDefaultFinalSize.h, (int)fOriginalDefaultFinalSize.v);
            }
        ...
        default: {
            ...
            return fCameraProfile.ParseTag(stream, parentCode, tagCode, tagType, tagCount, tagOffset);
        }
    }
...
bool dng_shared::Parse_ifd0_exif(dng_stream &stream,
    ...
    switch (tagCode) {
        case tcMakerNote: {
            ...
            if (gVerbose) {
                printf("MakerNote: Count = %u, Offset = %u\n", (unsigned)fMakerNoteCount, (unsigned)fMakerNoteOffset);
...
void dng_shared::PostParse(dng_host & /* host */, dng_exif & /* exif */) {
    ...
    if (fDNGVersion != 0) {
        ...
        if (fCameraProfile.fColorPlanes > 1) {
            ...
            if (fColorimetricReference == crICCProfilePCS) {
                if (fAsShotNeutral.NotEmpty()) {
                    ...
                    ReportWarning(
                        "AsShotNeutral not allowed for this "
                ...
                if (fAsShotWhiteXY.IsValid()) {
                    if (Abs_real64(fAsShotWhiteXY.x - pcs.x) > 0.01 || Abs_real64(fAsShotWhiteXY.y - pcs.y) > 0.01) {
                ...
                if (fAsShotNeutral.IsEmpty() && !fAsShotWhiteXY.IsValid()) {
                    ReportWarning("Neither AsShotNeutral nor AsShotWhiteXY included", "legal but not recommended");
                }
            ...
            if (fCameraProfile.fCalibrationIlluminant1 == lsStandardLightA && fCameraProfile.fCalibrationIlluminant2 == lsD65
                && fCameraCalibration1.Rows() == fCameraProfile.fColorPlanes && fCameraCalibration1.Cols() == fCameraProfile.fColorPlanes
                && fCameraCalibration2.Rows() == fCameraProfile.fColorPlanes && fCameraCalibration2.Cols() == fCameraProfile.fColorPlanes
                && fCameraCalibrationSignature.IsEmpty() && fCameraProfile.fProfileCalibrationSignature.IsEmpty()) {
        ...
        if (fLinearResponseLimit.As_real64() < 0.5 || fLinearResponseLimit.As_real64() > 1.0) {
#if qDNGValidate
...
bool dng_shared::IsValidDNG() {
    ...
    if (fCameraProfile.fColorPlanes > 1) {
        ...
        if (fCameraCalibration1.Cols() != 0 || fCameraCalibration1.Rows() != 0) {
            if (fCameraCalibration1.Cols() != fCameraProfile.fColorPlanes || fCameraCalibration1.Rows() != fCameraProfile.fColorPlanes) {
#if qDNGValidate
        ...
        if (fCameraCalibration2.Cols() != 0 || fCameraCalibration2.Rows() != 0) {
            if (fCameraCalibration2.Cols() != fCameraProfile.fColorPlanes || fCameraCalibration2.Rows() != fCameraProfile.fColorPlanes) {
#if qDNGValidate
