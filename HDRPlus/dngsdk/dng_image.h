...
class dng_tile_buffer : public dng_pixel_buffer, private dng_uncopyable {
protected:
...
public:
    void SetRefData(void *refData) { fRefData = refData; }

    void *GetRefData() const { return fRefData; }
};
...
public:
    ...
    void CopyArea(const dng_image &src, const dng_rect &area, uint32 plane, uint32 planes) { DoCopyArea(src, area, plane, plane, planes); }
    ...
    void SetConstant_uint8(uint8 value) { SetConstant(value, Bounds()); }
    ...
    void SetConstant_uint16(uint16 value) { SetConstant_uint16(value, Bounds()); }
    ...
    void SetConstant_int16(int16 value) { SetConstant_int16(value, Bounds()); }
    ...
    void SetConstant_uint32(uint32 value) { SetConstant_uint32(value, Bounds()); }
    ...
    void SetConstant_real32(real32 value) { SetConstant_real32(value, Bounds()); }
