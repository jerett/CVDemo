...
enum { depthFormatUnknown = 0, depthFormatLinear = 1, depthFormatInverse = 2 };

// Values for the DepthUnits tag.

enum { depthUnitsUnknown = 0, depthUnitsMeters = 1 };

// Values for DepthMeasureType tag.

enum { depthMeasureUnknown = 0, depthMeasureOpticalAxis = 1, depthMeasureOpticalRay = 2 };
