...
public:
    ...
    const char *Name() const { return fName.Get(); }
    ...
    virtual uint32 MaxThreads() const { return fMaxThreads; }
    ...
    virtual uint32 MinTaskArea() const { return fMinTaskArea; }
    ...
    virtual dng_point UnitCell() const { return fUnitCell; }
    ...
    virtual dng_point MaxTileSize() const { return fMaxTileSize; }
