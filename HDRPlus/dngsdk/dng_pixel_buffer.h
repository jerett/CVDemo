...
private:
    void *InternalPixel(int32 row, int32 col, uint32 plane = 0) const {
        ...
        return (
            void *)(((uint8 *)fData)
                    + (int64)fPixelSize
                          * (fRowStep * (int64)(row - fArea.t) + fColStep * (int64)(col - fArea.l) + fPlaneStep * (int64)(plane - fPlane)));
        ...
        return (
            void *)(((uint8 *)fData)
                    + (int32)fPixelSize
                          * (fRowStep * (int32)(row - fArea.t) + fColStep * (int32)(col - fArea.l) + fPlaneStep * (int32)(plane - fPlane)));
...
public:
    ...
    const dng_rect &Area() const { return fArea; }
    ...
    const void *ConstPixel(int32 row, int32 col, uint32 plane = 0) const { return InternalPixel(row, col, plane); }
