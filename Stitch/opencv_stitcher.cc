// this file is copy from opencv samples.
...
int main(int argc, char* argv[])
{
    ...
    for (int img_idx = 0; img_idx < num_images; ++img_idx)
    {
        ...
        else
        {
            ...
            cv::Mat img_show;
            img_warped_s.convertTo(img_show, CV_8UC3);
            // imshow("img warp " + std::to_string(img_idx), img_show);
            // imshow("img warp mask " + std::to_string(img_idx), mask_warped);
        }
    }
